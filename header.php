...
<php lang="zxx">
    ...
    <head>
        ...
        <link rel="shortcut icon" href="http://localhost/classified/favicon.ico" />
    ...
    <body>
        ...
        <script>
            function toggleDropdown() {
                const dropdown = document.querySelector("#locationDropdown ul");
            ...
            document.addEventListener("click", function(event) {
                const dropdown = document.querySelector("#locationDropdown ul");
                const dropdownContainer = document.querySelector("#locationDropdown");
