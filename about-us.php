<?php include 'header.php'; ?> 
 ...
 <section class="breadcrumb-section set-bg" data-setbg="img/categories/slider-2.jpg">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-8 pl-5">
                    <div class="about_content">
                        <h2 class="title mb-2">We Can Changes Your Business.</h2>
    ...
    <section class="services_area pt-5">
        <div class="container">
    ...
    <section class="counter_area bg_cover" style="background-image: url(img/banner/counter-bg.jpg)">
        <div class="container">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-3 col-sm-6">
                    <div class="single_team text-center mt-30">
                        <div class="team_image">
                            <img src="img/team/150-1.jpg" alt="team">
                        </div>
                        <div class="team_content">
                            <h6 class="team_name"><a href="#">Haven Somerville Byrd</a></h6>
                            <p>Web Designer</p>
                            <ul class="social">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="single_team text-center mt-30">
                        <div class="team_image">
                            <img src="img/team/150-10.jpg" alt="team">
                        </div>
                        <div class="team_content">
                            <h6 class="team_name"><a href="#">Haven Somerville Byrd</a></h6>
                            <p>Web Designer</p>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="single_team text-center mt-30">
                        <div class="team_image">
                            <img src="img/team/150-11.jpg" alt="team">
                        </div>
                        <div class="team_content">
                            <h6 class="team_name"><a href="#">Haven Somerville Byrd</a></h6>
                            <p>Web Designer</p>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="single_team text-center mt-30">
                        <div class="team_image">
                            <img src="img/team/150-14.jpg" alt="team">
                        </div>
                        <div class="team_content">
                            <h6 class="team_name"><a href="#">Haven Somerville Byrd</a></h6>
                            <p>Web Designer</p>
