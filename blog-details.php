<?php include 'header.php'; ?>
    ...
    <section class="blog-details-hero set-bg" data-setbg="img/banner/counter-bg.jpg">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="blog__details__hero__text">
                        <h2 class="blog-headding">Lorem ipsum dolor sit amet</h2>
                        <ul>
                            <li class="blog-headding">By Michael Scofield</li>
                            <li class="blog-headding">January 14, 2019</li>
                            <li class="blog-headding">8 Comments</li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-8 col-md-7 order-md-1 order-1 card">
                    <div class="blog__details__text pt-3">
                        ...
                        <p>The study area is located at the back with a view of the vast nature. Together with the other
                            ...
                            stables</p>
                            <img src="img/banner/counter-bg.jpg" alt="" class="rounded">
                            <h3>The corner window forms a place within a place that is a resting point within the large
                            space.</h3>
                        <p>The study area is located at the back with a view of the vast nature. Together with the other
                            buildings, a congruent story has been managed in which the whole has a reinforcing effect on
                    ...
                    <div class="blog_details_comment mt-30 mb-3">
                        <div class="blog_details_title">
                        ...
                        <div class="details_comment">
                            <ul class="comment">
                                <li>
                                    <div class="single_comment d-sm-flex">
                                        <div class="comment_author">
                                            <img src="img/team/150-2.jpg" alt="author">
                                        </div>
                                        <div class="comment_content media-body">
                                            <h5 class="title">Jhon Grantham</h5>
                                    ...
                                    <ul class="comment_replay">
                                        <li>
                                            <div class="single_comment d-sm-flex">
                                                <div class="comment_author">
                                                    <img src="img/team/150-5.jpg" alt="author">
                                                </div>
                                                <div class="comment_content media-body">
                                ...
                                <li>
                                    <div class="single_comment d-sm-flex">
                                        <div class="comment_author">
                                            <img src="img/team/150-6.jpg" alt="author">
                                        </div>
                                        <div class="comment_content media-body">
                                            <h5 class="title">Angel Grantham</h5>
                                            <span class="date">25 January, 2023</span>
